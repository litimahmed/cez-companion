                        ...
                        <Card className="border-border/50 bg-card">
                            <CardHeader className="border-b border-border/50 bg-secondary/30 dark:bg-secondary/50">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <CardTitle className="text-xl font-semibold text-foreground">Regional Settings</CardTitle>
                            ...
                            <CardContent className="pt-6 space-y-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="language" className="text-foreground">Default Language</Label>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="time-format" className="text-foreground">Time Format</Label>
                    ...
                    <Card className="border-border/50 bg-card">
                        <CardHeader className="border-b border-border/50 bg-secondary/30 dark:bg-secondary/50">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle className="text-xl font-semibold text-foreground">Queue Configuration</CardTitle>
                        ...
                        <CardContent className="pt-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <div className="space-y-2">
                                    <Label htmlFor="default-capacity" className="text-foreground">Default Queue Capacity</Label>
                                    <Input
                                        id="default-capacity"
                                        type="number"
                                        defaultValue="50"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="avg-service-time" className="text-foreground">Avg. Service Time (minutes)</Label>
                                    <Input
                                        id="avg-service-time"
                                        type="number"
                                        defaultValue="15"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="refresh-interval" className="text-foreground">Auto-refresh Interval (seconds)</Label>
                                    <Input
                                        id="refresh-interval"
                                        type="number"
                                        defaultValue="30"
                ...
                <TabsContent value="notifications" className="space-y-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <Card className="border-border/50 bg-card">
                            ...
                            <CardContent className="pt-6 space-y-4">
                                <div className="flex items-center justify-between p-3 rounded-lg bg-secondary/20 dark:bg-secondary/40">
